...
public class PricePlanService {
    ...
    public Optional<Map<String, BigDecimal>> getConsumptionCurrentWeek(String smartMeterId) {
        Optional<List<ElectricityReading>> electricityReadings = meterReadingService.getReadingsCurrentWeek(smartMeterId);
