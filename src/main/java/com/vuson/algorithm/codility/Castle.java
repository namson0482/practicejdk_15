 ...
 * <p>
 * Let [P..Q] denote a group of consecutive segments from P to Q inclusive such that (0 ≤ P ≤ Q  ≤ N-1). Segments P..O form a hill or a valley if all the following conditions are satisfied:
 ...
 * Note that if the surroundinas on either side of the hill or valley don't exist (i.e. at the edaes
 ...
 * <p>
 * There are two hills: [3.31 and [11_111. There are also two vallevs: [o.11 and [8. 9]. There are no other suitable places tor castles
 * Write a function
 * public int solution
 * that, given an array A consisting of N integers, as explained above, returns the total number of hills and valleys.
 * <p>
 * For example aiven arrav A as described above the tunction should return 4
 * <p>
